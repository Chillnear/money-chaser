...
# หมายเหตุ (2026-07-29): เคยมีเทสต์ P5.9b สำหรับ funding_carry override ตรงนี้ — ถอด feature ออกแล้ว
# หลัง rule_backtest.py (--coins auto) ยืนยันว่าผลกลับตาลปัตรตอนทดสอบด้วยพูลเหรียญจริงหลายตัว (ดู
# src/main.py ด้านบน) เหลือไว้แค่ src/shadow.py ที่ track แบบ shadow ไม่กระทบการเทรดจริง
